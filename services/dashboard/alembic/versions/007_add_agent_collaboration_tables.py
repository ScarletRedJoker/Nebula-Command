...
def upgrade():
    # 1. Agents table - stores AI agents in the swarm
    op.create_table(
        'agents',
    ...
    # 2. Agent tasks table - stores tasks assigned to agents
    op.create_table(
        'agent_tasks',
        sa.Column('id', sa.Integer(), nullable=False, autoincrement=True),
    ...
    # 3. Agent conversations table - stores agent-to-agent communication
    op.create_table(
        'agent_conversations',
        sa.Column('id', sa.Integer(), nullable=False, autoincrement=True),
    ...
    # 4. Add foreign key for current_task_id in agents table (self-referential)
