...
def upgrade() -> None:
    ...
    # ============================================
    if 'plex_import_jobs' not in existing_tables:
        op.create_table(
            'plex_import_jobs',
    ...
    if 'plex_import_items' not in existing_tables:
        op.create_table(
            'plex_import_items',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    # ============================================
    if 'service_telemetry' not in existing_tables:
        op.create_table(
            'service_telemetry',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    # ============================================
    if 'storage_metrics' not in existing_tables:
        op.create_table(
            'storage_metrics',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    if 'storage_alerts' not in existing_tables:
        op.create_table(
            'storage_alerts',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    # ============================================
    if 'game_sessions' not in existing_tables:
        op.create_table(
            'game_sessions',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    if 'sunshine_hosts' not in existing_tables:
        op.create_table(
            'sunshine_hosts',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    # ============================================
    if 'db_credentials' not in existing_tables:
        op.create_table(
            'db_credentials',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    if 'db_backup_jobs' not in existing_tables:
        op.create_table(
            'db_backup_jobs',
            sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
            sa.Column('db_name', sa.String(255), nullable=False),
